...
public class BatBulletsController : Bullet
{
    public BatAI batController;
    ...
    {
        damage = batController.bulletDamage;
        speed = batController.bulletSpeed;
        destroyableByPlayerBullets = batController.bulletDestroyableByPlayer;
